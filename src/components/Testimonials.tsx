...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-20 bg-brand-cream border-b-4 border-brand-charcoal px-4 sm:px-6 lg:px-8 relative overflow-hidden">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 text-brand-yellow fill-brand-yellow stroke-brand-charcoal stroke-2" />
                    ))}
                  </div>
                ...
                <div className="pt-6 mt-6 border-t-2 border-brand-charcoal/10 flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-full border-2 border-brand-charcoal font-display font-black text-lg flex items-center justify-center shadow-neo-xs ${avatarStyle}`}>
                  ...
                  <div>
                    ...
                    <p className="font-sans text-xs text-brand-charcoal/60 mt-1">
                      {item.relationship} of {item.childName} (Age {item.childAge})
                    </p>
                  </div>
                </div>
